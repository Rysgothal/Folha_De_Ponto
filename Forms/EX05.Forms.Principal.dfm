object frmPrincipal: TfrmPrincipal
  ...
  object memHistHorario: TMemo
    ...
    Lines.Strings = (
      ' ====================================='
      ' Registro de Ponto Semanal - Hist'#243'rico'
      ' ====================================='
      ' '
      ' C'#243'digo...........: 000001'
      ' Funcion'#225'rio......: KATIA ALBUQUERQUE DE SOUZA'
      ' Admiss'#227'o.........: 01/06/2010 -> 12 Anos; 3 Meses; 1 Dia.'
      ' Jornada semanal..: 44 horas'
      ' Intervalo almo'#231'o.: 01:30 -> 1 hora e 30 minutos.'
      ' '
        ...
        ' | DIA DA SEMANA  | ENTRADA | SA'#205'DA ALMO'#199'O | RETORNO ALMO'#199'O | SA' +
        #205'DA FINAL | TOTAL HORAS | '
        ...
        ' | Segunda-Feira  |  08:00  |    12:00     |     13:30      |   ' +
        ' 17:30    |    08:00    | '
      
        ' |----------------|---------|--------------|----------------|---' +
        '----------|-------------| '
      
        ' | Ter'#231'a-Feira    |  08:10  |    12:00     |     13:40      |   ' +
        ' 17:35    |    07:45    | '
      
        ' |----------------|---------|--------------|----------------|---' +
        '----------|-------------| '
      
        ' | Quarta-Feira   |  07:55  |    12:15     |     13:30      |   ' +
        ' 17:30    |    08:20    | '
      
        ' |----------------|---------|--------------|----------------|---' +
        '----------|-------------| '
      
        ' | Quinta-Feira   |  08:00  |    12:00     |     13:30      |   ' +
        ' 17:30    |    08:00    | '
      
        ' |----------------|---------|--------------|----------------|---' +
        '----------|-------------| '
      
        ' | Sexta-Feira    |  08:00  |    00:00     |     00:00      |   ' +
        ' 17:30    |    09:30    | '
