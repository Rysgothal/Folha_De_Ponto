...
//    TConstantes.LINHAS_LAYOUT_DADOS_FUNCIONARIOS,
    [lFolhaPonto.ID, lFolhaPonto.Nome, lFolhaPonto.DataAdmissao, lFolhaPonto.JornadaSemanal, lFolhaPonto.IntervaloAlmoco]
  );
end;
