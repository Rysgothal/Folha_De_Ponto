unit Exercicio05.Classes.Horarios;
...
type
  ...
  public
    ...
    property SaidaAlmoco: string read FSaidaAlmoco write FSaidaAlmoco;
    property RetornoAlmoco: string read FRetornoAlmoco write FRetornoAlmoco;
    property SaidaFinal: string read FSaidaFinal write FSaidaFinal;
